...
from modified_ttkbootstrap.themes.standard import STANDARD_THEMES
from modified_ttkbootstrap.publisher import Publisher, Channel
from modified_ttkbootstrap import utility as util
from modified_ttkbootstrap import colorutils
from PIL import ImageColor

try:
    # prevent app from failing if user.py gets corrupted
    from modified_ttkbootstrap.themes.user import USER_THEMES
...
class Style(ttk.Style):
    ...
    modified_ttkbootstrap, this class is implemented as a singleton. Subclassing
    ...
    def __init__(self, theme=DEFAULT_THEME):
        ...
        # apply localization
        from modified_ttkbootstrap import localization
    ...
    def configure(self, style, query_opt: Any = None, **kw):
        ...
        if ttkstyle == style:
            ...
            # subclass a modified_ttkbootstrap theme
            result = super().configure(style, query_opt=query_opt, **kw)
            self._register_ttkstyle(style)
            return result

    def theme_names(self):
        """Return a list of all modified_ttkbootstrap themes.
    ...
    def _load_themes(self):
        """Load all modified_ttkbootstrap defined themes"""
...
class StyleBuilderTTK:
    ...
    def create_floodgauge_style(self, colorname=DEFAULT):
        """Create a ttk style for the modified_ttkbootstrap.widgets.Floodgauge
    ...
    def create_date_button_assets(self, foreground):
        ...
        modified_ttkbootstrap.widgets.DateEntry.
    ...
    def create_calendar_style(self, colorname=DEFAULT):
        ...
        modified_ttkbootstrap.dialogs.DatePickerPopup widget.
    ...
    def create_metersubtxt_label_style(self, colorname=DEFAULT):
        ...
        modified_ttkbootstrap.widgets.Meter widget.
    ...
    def create_meter_label_style(self, colorname=DEFAULT):
        ...
        modified_ttkbootstrap.widgets.Meter widget. This style also stores some
...
class Bootstyle:
    ...
    def setup_ttkbootstap_api():
        """Setup modified_ttkbootstrap for use with tkinter and ttk. This method
        is called when modified_ttkbootstrap is imported to perform all of the
        necessary method overrides that implement the bootstyle api."""
        from modified_ttkbootstrap.widgets import TTK_WIDGETS
        from modified_ttkbootstrap.widgets import TK_WIDGETS
        import tkinter.ttk
        # TTK WIDGETS
        for widget in TTK_WIDGETS:
            if widget == tkinter.ttk.Notebook:
                continue  # 不搞notebook，避免覆盖关闭按钮
            try:
