"""
    ...
    tkinter.Tk and modified_ttkbootstrap.style.Style classes to provide a more
    consolidated api for initial application startup.
"""
import tkinter
from modified_ttkbootstrap.constants import *
from modified_ttkbootstrap.publisher import Publisher
from modified_ttkbootstrap.style import Style
from modified_ttkbootstrap.icons import Icon
from modified_ttkbootstrap import utility
...
class Window(tkinter.Tk):
    ...
    def __init__(
        ...
        Parameters:
            ...
            themename (str):
                The name of the modified_ttkbootstrap theme to apply to the
                application.
            ...
            iconphoto (str):
                ...
                A modified_ttkbootstrap image is used by default. To disable
        ...
        if iconphoto is not None:
            if iconphoto == '':
                # the default modified_ttkbootstrap icon
    ...
    @property
    def style(self):
        """Return a reference to the `modified_ttkbootstrap.style.Style` object."""
        return self._style
